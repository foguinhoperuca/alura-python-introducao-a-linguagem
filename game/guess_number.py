...
def play():
    ...
    print("The price for game ticket is:"
          " EASY ({:d} points and {:d} attempts) ${:.2f};"
          " NORMAL ({:d} points and {:d} attempts) ${:.2f};"
          " HARD ({:d} points and {:d} attempts) ${:.2f}.".format(1000, 5, 100.00, 100, 3, 10.00, 10, 1, 0.99))
    ...
    for turn in range(1, (attempts + 1)):
        ...
        if guess < 1 or guess > 100:
            print("Penalty! You *SHOULD* try numbers between 1 and 100!!"
                  " You lost this turn: {0} of {1}!".format(turn, attempts))
            print("------------------------------------")
            continue
