...
def lecture_01() -> None:
    ...
    rj = gpd.read_file('alura_curso_geopandas_02/dados/RJ_Municipios_2022.shp')  # noqa: E501
    print(rj.head())
    print(type(rj))
    rj.plot()
    ...
    rj_municip = gpd.read_file(f'{Util.GEO_02_NEW_INPUT}/rj_municip.shp')
...
def challenge_01() -> None:
    ...
    sp_state = gpd.read_file(f'{Util.GEO_02_NEW_DATA}/Estado_SP.shp')
    print(sp_state.head())
    print('-------------')
    ...
    sp = gpd.read_file(f'{Util.GEO_02_NEW_INPUT}/sp_municip.shp')
